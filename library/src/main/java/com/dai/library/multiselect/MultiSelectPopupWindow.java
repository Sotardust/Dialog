...
public class MultiSelectPopupWindow {
    ...
    public static class Builder {
        ...
        public MultiSelectPopupWindow build() {
            return new MultiSelectPopupWindow(this);
        }
    ...
    private MultiSelectPopupWindow(final Builder builder) {
        ...
        adapter.setOnSelectChangeListener(new MultiSelectAdapter.OnSelectChangeListener() {
            @Override
    ...
    private void initView(View view) {
        ...
        if (builder.itemSelectedTextColor != 0) {
            adapter = new MultiSelectAdapter(builder.activity, builder.itemSelectedTextColor);
        } else {
            adapter = new MultiSelectAdapter(builder.activity);
        }
